...
class PostsBrowserViewModelTest {
    ...
    @Test
    fun `missing config goes straight to NotConfigured`() =
        runTest {
    ...
    @Test
    fun `resolves a relative archive url against the web origin`() =
        runTest {
    ...
    @Test
    fun `uses an absolute archive url verbatim`() =
        runTest {
    ...
    @Test
    fun `falls back when the manifest has no archive url`() =
        runTest {
    ...
    @Test
    fun `a not-ok manifest is an error`() =
        runTest {
    ...
    @Test
    fun `a NotFound from the service maps to NotConfigured`() =
        runTest {
